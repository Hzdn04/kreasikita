                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :loop="true" :dots="false" :nav="false">
                                    <div class="pt" @click="changeImage(thumbs[0])" :class="thumb=[0] == image_default ? 'active' : '' ">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[1])" :class="thumb=[1] == image_default ? 'active' : '' ">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[2])" :class="thumb=[2] == image_default ? 'active' : '' ">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[3])" :class="thumb=[3] == image_default ? 'active' : '' ">
...
<script>
// @ is an alias to /src
import HeaderMp from '@/components/HeaderMp.vue'
